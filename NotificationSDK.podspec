...
Pod::Spec.new do |spec|
  ...
  # spec.requires_arc = true
    ...
    spec.ios.vendored_frameworks = "NACallSDK.framework", "NALocalization.framework", "NetAloLite.framework", "NARealmPlatform.framework", "NANetworkPlatform.framework", "NADomain.framework", "NACoreUtils.framework", "NASocketPlatform.framework"
