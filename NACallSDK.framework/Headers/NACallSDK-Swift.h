...
#ifndef NACALLSDK_SWIFT_H
#define NACALLSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NACallSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9NACallSDK12WebRTCClient")
...
@interface WebRTCClient (SWIFT_EXTENSION(NACallSDK)) <RTCDataChannelDelegate>
...
@interface WebRTCClient (SWIFT_EXTENSION(NACallSDK)) <RTCPeerConnectionDelegate>
