...
#ifndef NANETWORKPLATFORM_SWIFT_H
#define NANETWORKPLATFORM_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NANetworkPlatform",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
///   </li>
/// </ul>
SWIFT_CLASS("_TtC17NANetworkPlatform21AsynchronousOperation")
...
SWIFT_CLASS("_TtC17NANetworkPlatform17DownloadOperation")
...
SWIFT_CLASS("_TtC17NANetworkPlatform15UploadOperation")
@interface UploadOperation : AsynchronousOperation
- (void)main;
- (void)cancel;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
