...
Pod::Spec.new do |spec|
  ...
  # spec.requires_arc = true
    ...
    spec.ios.vendored_frameworks = "NotificationComponent.framework", "NALocalization.framework", "NASocketPlatform.framework", "NetAloLite.framework", "NARealmPlatform.framework", "NANetworkPlatform.framework", "NADomain.framework", "NACoreUtils.framework",
